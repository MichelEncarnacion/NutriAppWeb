...
const VARIANTS = {
    primary:   "bg-brand-green text-black hover:bg-brand-greenL",
    secondary: "bg-dark-800 text-text-primary border border-dark-600 hover:border-text-muted",
    ghost:     "bg-transparent text-text-muted hover:bg-dark-800 hover:text-text-primary",
