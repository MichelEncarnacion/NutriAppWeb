...
export default function Diagnostico() {
    ...
    const guardar = async () => {
        ...
        const datos = {
            ...
            meta_personal: respuestas.meta_personal ?? null,
            ocupacion: respuestas.ocupacion ?? null,
            nivel_actividad: respuestas.nivel_actividad ?? null,
            dias_ejercicio: respuestas.dias_ejercicio ?? null,
            tipo_ejercicio: respuestas.tipo_ejercicio ?? [],
            comidas_por_dia: Number(respuestas.comidas_por_dia) || null,
            horario_primer_comida: respuestas.horario_primer_comida ?? null,
            horario_ultima_comida: respuestas.horario_ultima_comida ?? null,
            habitos_alimenticios: respuestas.preferencias_comida ?? null,
            alimentos_no_gustados: respuestas.alimentos_no_gustados ?? [],
            ...
            vasos_agua: Number(respuestas.vasos_agua) || null,
            horas_sueno: Number(respuestas.horas_sueno) || null,
            consume_alcohol: respuestas.consume_alcohol ?? null,
            nivel_estres: respuestas.nivel_estres ?? null,
            tiempo_cocina: Number(respuestas.tiempo_cocina) || null,
        };
